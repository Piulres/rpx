...
class Add5b589aa1e6535RelationshipsToAssetTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function down()
    {
        Schema::table('assets', function(Blueprint $table) {
            if(Schema::hasColumn('assets', 'category_id')) {
                $table->dropForeign('188464_5b58941e07edd');
                $table->dropIndex('188464_5b58941e07edd');
                $table->dropColumn('category_id');
            }
            if(Schema::hasColumn('assets', 'status_id')) {
                $table->dropForeign('188464_5b58941e1d027');
                $table->dropIndex('188464_5b58941e1d027');
                $table->dropColumn('status_id');
            }
            if(Schema::hasColumn('assets', 'location_id')) {
                $table->dropForeign('188464_5b58941e30c46');
                $table->dropIndex('188464_5b58941e30c46');
                $table->dropColumn('location_id');
            }
            if(Schema::hasColumn('assets', 'assigned_user_id')) {
                $table->dropForeign('188464_5b58941e4dfc5');
                $table->dropIndex('188464_5b58941e4dfc5');
